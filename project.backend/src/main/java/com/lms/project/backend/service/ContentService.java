...
public class ContentService {
    ...
    public List<Content> getAllContent(String accountId) throws IOException {
        ...
        if (!allContent.isEmpty()) {
            for (Content content : allContent) {
                ...
                Content eachContent = new Content(content.getTitle(), content.getContentId(),
                        content.getDateCreated(), content.getDateEdited(),
                        content.getNumberOfAccess());
    ...
    public Content getContent(String contentId, String accountId) throws IOException {
